...
class Scroller(object):
    ...
    def add_buildings(self):
        ...
        while current_width <= self.width:
            ...
            current_width += self.buildings[current_building].width
            current_building += 1
    ...
    def add_building(self, x_location):
        ...
        building_height = random.randint(int(self.base * 0.2), int(self.base * 0.8))
        building_width = random.randint(int(self.width * 0.1) , int(self.width * 0.25))
...
"""
Draw a test building like this:
    test_building = Building(100, 100, 300, 200, FRONT_SCROLLER_COLOR)
"""
# -------- Main Program Loop -----------
while not done:
    # --- Main event loop
    ...
    """
    Test the test_building like this:
        test_building.draw()
        test_building.move(3)
    """
